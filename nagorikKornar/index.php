...
<h2>ওটিপি অথবা গুগল দিয়ে লগইন করুন</h2>
 <?php //echo $fbLgnBtn; ?>
<button href="javascript:void(0)" onclick="window.location = '<?php echo $loginurl;?>'"  data-toggle="tooltip"  class="loginBtn loginBtn--google" > গুগল দিয়ে লগইন করুন</button>
...
<button href="javascript:void(0)" onclick="window.location = '../nagorik_kornar'"  data-toggle="tooltip"  class="loginBtn loginBtn--otp" > ওটিপি দিয়ে লগইন করুন</button>
<?php }else{?>
<div class=" ">
<div class="col-sm-12 ">                               
...
অভিযোগের  বিষয় <span class="color">*</span></label>
                            <div class="col-sm-9">
                                <span id="txtsubject-info" class="info" ></span>
                                <input type="text" class="form-control " name="txtsubject" id="txtsubject" value="" placeholder="অভিযোগের  বিষয়">
                            </div>
                        </div>
                    </div>
                </div> 
...
অভিযোগের  বিবরণ <span class="color">*</span></label>
                            <div class="col-sm-9">
                                <span id="txtdescription-info" class="info" ></span>
                                <textarea type="text" class="form-control " name='txtdescription' id='txtdescription' placeholder="অভিযোগের  বিবরণ"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
মন্তব্য <span class="color">*</span></label>
                            <div class="col-sm-9">
                                ...
                                <textarea type="text" class="form-control " name='solv_solution' id='solv_solution' placeholder="মন্তব্য"></textarea>
                            </div>
                        </div>
                    </div>
