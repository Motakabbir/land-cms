...
$.fn.clock = function(options) {
  var locale = {
    ...
    "en":{
      ...
      "months":["Jan","Feb","Mar","Apr","May","June","July","Aug","Sep","Octr","Nov","Dec"]
    },
    "es":{
  ...
  return this.each(function(){
    ...
    updateClock = function(el,myoptions) {
      ...
      if(myoptions=="destroy"){ clearTimeout(t[el_id]); }
        ...
        $(el).html('<i class="fa fa-clock-o" aria-hidden="true"></i> '+h+":"+m+(options.seconds == "true"?":"+s:"")+ap +' | <i class="fa fa-calendar" aria-hidden="true"></i> '+ calend);
