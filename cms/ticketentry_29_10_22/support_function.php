...
function call_success_info($agent_id, $citizen_mobile, $citizen_name=null, $application_type, $subject=null, $description=null, $email=null, $address=null, $division_bbs=null, $district_bbs=null, $upozila_bbs=null, $application_code=null, $txtcontact_person_no=null, $nid=null, $dateOfBirth=null,$service_tag=null ){
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://hotline.land.gov.bd/return/message/message_internal.php',
  //CURLOPT_URL => 'http://192.168.88.129/landnew//return/message/message_internal.php',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
