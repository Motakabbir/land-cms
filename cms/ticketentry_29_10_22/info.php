...
// Print_r($_REQUEST);
// exit;
if ($task_type > 0 && $txtcontact_number != '' && $service_type > 0 && $service_tag > 0 )
{
  //echo 'sdsadad';
    ...
    if ($info_type == '20')
    {
        ...
        curl_close($ch);
        call_success_info( $SUserID, $txtcontact_number, $txtcontact_person, $service_type, $txtsubject, $txtdescription, $txtcontact_email, $txtaddress, $division_id, $district, $upozila, "", $txtcontact_person_no, $nid, $dateOfBirth,$service_tag );
