...
<body  data-skin-type="skin-polaris-blue" class="skin-colortic" >
         ...
         <div class="col-md-12 pl0 pr0 main-body">
            <div class="blog blog-info">
               <div class="blog-header text-center">
                  <h5 class="blog-title">বিস্তারিত প্রতিবেদন  </h5>
               </div>
               <div class="blog-body ">
                  <form id="search">
                     <div class="row">
                        ...
                        <div class=" form-group col-sm-2">
                           <select name="service_type" id="service_type" class="form-control input-sm">
                              <option value="" selected>ক্যাটাগরি </option>
                        ...
                        <div class=" form-group col-sm-3">
                           <select class="form-control input-sm SlectBox  "  placeholder="সকল সার্ভিস টাইপ ট্যাগ " multiple="multiple" name='service_tag[]' id='service_tag' style="width:100%" >
                           <?php
                              createCombo( "সকল সার্ভিস টাইপ ট্যাগ", "tbl_service_tag", "id", "name", "Order by id",$servicetag);
                              ?>
                           </select>
                        </div>
                     </div>
   ...
   $.ajax({
   	...
   	data: {
   		...
   		firstText:'সকল সার্ভিস টাইপ ট্যাগ ',
   	},
   	success: function(response) {
   		//alert(response);
   		var value= "<option value=\"-1\">সকল সার্ভিস টাইপ ট্যাগ </option>" +response;
