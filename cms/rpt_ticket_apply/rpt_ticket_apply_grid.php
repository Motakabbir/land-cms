...
<body  data-skin-type="skin-polaris-blue" class="skin-colortic" >
 <div id="load" style="    position: fixed; margin-top: 18%;left: 44%; z-index: 99999999;color: #4569af;font-size: 20px;text-align: center;"> <i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i>
                    	    ...
                    	    <form id="search">
                                    ...
                                    <div class=" form-group col-sm-3">
                                       <select  name='probtype[]' multiple="multiple" placeholder="সকল সেবার ধরণ " class="SlectBox from-control input-sm">
										<?php createCombo("সকল সেবার ধরণ ","tbl_service_type","prob_id","prob_name"," where tbl_service_type.`srv_type` in (2) ORDER BY prob_id",$prob_type); ?>       
                                        </select>
                                    </div>
