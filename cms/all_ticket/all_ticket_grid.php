...
<div class="col-sm-12">
  <div class="affectedDiv">
    <ul class="nav nav-tabs" id="myTab">
      <li class="active"><a data-toggle="tab" href="#tab40"><i class="fa fa-area-chart" aria-hidden="true"></i> &nbsp;নতুন  অভিযোগ</a></li>
      <li><a data-toggle="tab" href="#tab41"><i class="fa fa-area-chart" aria-hidden="true"></i> &nbsp;চলমান  অভিযোগ </a></li>
      <li><a data-toggle="tab" href="#tab42"><i class="fa fa-envira" aria-hidden="true"></i> &nbsp; নিষ্পন্ন  অভিযোগ</a></li>
<?php	  if($SType==36) { ?>
      <li><a data-toggle="tab" href="#tab43"><i class="fa fa-filter " aria-hidden="true"></i> &nbsp; অভিযোগ</a></li>
<?php }?>
	   <li><a data-toggle="tab" href="#tab44"><i class="fa fa-filter " aria-hidden="true"></i> &nbsp; বাতিল  অভিযোগ</a></li>
    </ul>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
	...
	sendData("all_cancel_ticket_get.php", '#tab44', 1);
  });
