            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%" class="borderTable">
                ...
                <tr>
                	<td><strong>বর্তমান অবস্থা :</strong></td>
					 <td><?php echo $task_statusname; 
					
					 if($solv_by>1) {echo",  নিস্পন্নকারী : $solv_by_name";
					 } else {
						 if($last_user_group>1)
							{
							echo",  অফিসার নাম : $last_user_group_name";
							}
					}?></td>
    ...
    <div class="row">
            ...
            <?php if($SType==$last_user_group){?>
            	<div class="row">
                	<div class="col-sm-12">
                        ...
                        <button type="button" onClick="save_update_inline('গৃহীত কার্যক্রম')" class="btn btn-warning btn-sm pull-right" ><i class="fa fa-" aria-hidden="true"></i> সংরক্ষণ করুন</button>	      
                        </form>  
                    </div>
                </div>
               <?php }?>
        ...
        <div class="col-sm-4">
            ...
            <div class="row">
                ...
                <button type="button" onClick=" save_stats_inline('সমাধানের পদ্ধতি')" class="btn btn-warning btn-sm pull-right" ><i class="fa fa-" aria-hidden="true"></i> সংরক্ষণ করুন</button>
                </form> 
                 </div>
                 </div>
            <?php }?>     
        ...
        <div class="col-sm-4">
            ...
            <strong>  আপনার মন্তব্য: </strong>
                ...
                <!--<button  type="button" class="btn btn-warning btn-sm" onclick="taskview(<?php //echo $task_id;?>)" ><i class="fa fa-print" aria-hidden="true"></i>প্রিন্ট</button>-->
                 <button type="button"  class="btn btn-primary btn-sm" onclick="forward_task(<?php echo $task_id;?>)" data-toggle="modal" data-target="#myModalsmall"><i class="fa fa-share" aria-hidden="true"></i> স্থানান্তর </button>   
