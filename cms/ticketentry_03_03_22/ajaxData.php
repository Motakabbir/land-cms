               ...
               <table class="table table-condensed table-bordered" cellpadding="0" cellspacing="0" style="width:100%">
                   ...
                   <?php 
					...
					<tr class="<?php echo $color;?>" >
                           ...
                           <td>
                           	<button type="button" id="btn1" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal1 " onclick="showDetails(<?php echo $task_id;?>)" ><i class="fa fa-info-circle"></i> বিস্তারিত</button>
