 ...
 <div class="col-md-6" style="margin-top:5px">
  <div class="nav-tabs-custom box-danger">
    <ul class="nav nav-tabs pull-right">
      ...
      <li class="pull-left header"><i class="fa fa-th"></i> সকল <?php echo $call; ?></li>
    </ul>
    <div class="tab-content" style="background:#E8E8E8">
 ...
 <div class="col-md-6" style="margin-top:5px">
  <div class="nav-tabs-custom box-danger">
    <ul class="nav nav-tabs pull-right">
      ...
      <li class="pull-left header"><i class="fa fa-th"></i>অনিষ্পন্ন <?php echo $call; ?></li>
    </ul>
    <div class="tab-content" style="background:#E8E8E8">
 ...
 <div class="col-md-12" style="margin-top:5px">
  <div class="nav-tabs-custom box-danger">
    <ul class="nav nav-tabs pull-right">
      ...
      <li class="pull-left header"><i class="fa fa-th"></i>  সেবা এর প্রকারভেদ অনুযায়ী <?php echo $call; ?></li>
    </ul>
    <div class="tab-content" style="background:#E8E8E8">
